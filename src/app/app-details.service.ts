...
export class AppDetailsService {
  static apps: App[] = [
    ...
    info2: "I leveraged the power of MapBoxGL's Api to add map functionality to the application. This application was built using Vue.js for the frontend. Node.js, Express and MongoDB to build out the backend.",
    ...
    github: "https://github.com/JacksonSchacher/Tripr_App",
    website: ""
  },
  {
    title: "BugTracker",
    ...
    img1: "",
    info1: "Utilized MVC design pattern, reusable code, and RESTful API practices.",
    img2: "",
    info2: "Fullstack application build, one to many, many to many relationships",
    img3: "",
    info3: "",
